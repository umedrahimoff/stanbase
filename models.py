...
class Company(Base):
    ...
    portfolio_entries = relationship('PortfolioEntry', backref='company', cascade='all, delete-orphan')
    users = relationship('User', backref='company', cascade='all, delete-orphan')
    comments = relationship('Comment', backref='company', cascade='all, delete-orphan')
